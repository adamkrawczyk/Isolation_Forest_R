...
```
```{r message=FALSE, echo=FALSE,results='hide',fig.keep='all', eval=FALSE}
data_to_test <- http_data_df
...
Nie udało się porównać wyników dla dużych zbiorów danych ze względu na ograniczenia mocy obliczeniowej komputerów którymi dysponujemy. 
